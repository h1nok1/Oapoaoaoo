...
app = FastAPI(title="Nyx - Liquid Glass + Fsociety")
...
# ----- КАНАЛЫ (С ЮЗЕРНЕЙМОМ И ФИКСОМ ПОЯВЛЕНИЯ) -----
...
<head>
    <meta charset="UTF-8">
    <title>Nyx — Liquid Glass + Fsociety</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glass-btn:hover {
            ...
            box-shadow: 0 4px 16px rgba(0, 255, 157, 0.04);
        }
        .story-btn {
        ...
        .search-results::-webkit-scrollbar, .search-history::-webkit-scrollbar {
            width: 2px;
        }
        .search-results::-webkit-scrollbar-thumb, .search-history::-webkit-scrollbar-thumb {
            background: rgba(0, 255, 157, 0.1);
            border-radius: 4px;
        }
        .search-item {
...
<div id="app">
    ...
    <div id="mainScreen">
        <div class="glass-header">
            ...
            <div class="actions">
                <button class="glass-btn" onclick="openSearchMenu()" title="Поиск">🔍</button>
                <button class="glass-btn story-btn" onclick="uploadStory()" title="Добавить историю">📸</button>
                <button id="adminTabBtn" class="hidden glass-btn" onclick="switchTab('admin')">⚡</button>
        ...
        try {
            ...
            list.innerHTML = channels.map(ch => {
                ...
                <div class="channel-item">
                    ...
                    <div class="meta">@${ch.username} • ${ch.subscribers} подписчиков</div>
                    <div class="actions">

...
<head>
    ...
    <style>
        /* ============================================================
           FSOIETY + LIQUID GLASS — ПОЛНЫЙ РЕДИЗАЙН
           ============================================================ */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (min-width: 480px) {
            #app { border-radius: 24px; height: 95vh; border: 1px solid rgba(255, 26, 26, 0.06); }
        }
        ...
        .story-item .story-avatar.viewed {
            border-color: #556677;
            opacity: 0.6;
        }
        ...
        .action-buttons .channel-btn {
            background: linear-gradient(135deg, rgba(204, 0, 0, 0.08), rgba(255, 26, 26, 0.02));
            color: #ff1a1a;
        ...
        .action-buttons .group-btn {
            background: linear-gradient(135deg, rgba(0, 255, 157, 0.04), rgba(0, 255, 157, 0.02));
            color: #00ff9d;
            border-color: rgba(0, 255, 157, 0.04);
        }
        .action-buttons .group-btn:hover {
            background: linear-gradient(135deg, rgba(0, 255, 157, 0.06), rgba(0, 255, 157, 0.04));
...
<script>
    ...
    async function loadStories() {
        try {
            ...
            if (usernames.length === 0) {
                container.innerHTML = `<div style="color:#667788;font-size:12px;padding:4px 0;">Нет историй</div>`;
                return;
            }
    ...
    function showStoryViewer() {
        ...
        viewer.innerHTML = `
            ...
            <div style="color:#8899bb;font-size:14px;margin-top:8px;">${currentStoryIndex+1}/${stories.length}</div>
        `;
    ...
    async function switchAccountInstant(username) {
        ...
        document.getElementById('profileContent').innerHTML = `<div style="text-align:center;padding:40px;color:#884444;">🔄 Переключение...</div>`;
    ...
    function renderSettings() {
        ...
        container.innerHTML = `
            ...
            <div style="display:flex;flex-direction:column;gap:6px;">
                ...
                ${isAdmin ? `
                    <div style="display:flex;justify-content:space-between;padding:10px 12px;background:rgba(255,26,26,0.02);border-radius:8px;border:1px solid rgba(255,26,26,0.02);cursor:pointer;" onclick="loadAdminStats()">

...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .search-item .name { font-weight: 500; font-size: 13px; color: rgba(255, 255, 255, 0.04); font-family: 'Orbitron', monospace; }
...
<script>
    ...
    async function loadChats() {
        try {
            ...
            if (chats.length === 0) {
                list.innerHTML = `<div style="text-align:center;padding:40px 20px;color:rgba(255,255,255,0.02);font-size:13px;font-family:'Orbitron',monospace;">

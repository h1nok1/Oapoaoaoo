...
# ----- ГЛАВНАЯ СТРАНИЦА (ТОТАЛЬНЫЙ РЕДИЗАЙН — СИНИЙ НЕОН) -----
...
<head>
    ...
    <title>DELTA — Fsociety</title>
    <link rel="manifest" href="/manifest.json">
    <style>
        /* ============================================================
           ТОТАЛЬНЫЙ РЕДИЗАЙН — DELTA (СИНИЙ НЕОН)
           ============================================================ */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bg-layer {
            ...
            height: 100%;
            z-index: 0;
            background: radial-gradient(ellipse at 20% 50%, rgba(0, 102, 255, 0.03), transparent 60%),
                        radial-gradient(ellipse at 80% 50%, rgba(0, 136, 255, 0.02), transparent 60%),
                        #05080f;
        }
        ...
        #app {
            ...
            box-shadow: 0 0 80px rgba(0, 102, 255, 0.02), inset 0 1px 0 rgba(0, 102, 255, 0.02);
            display: flex;
        ...
        @media (min-width: 480px) {
            #app { border-radius: 28px; height: 95vh; border: 1px solid rgba(0, 102, 255, 0.04); }
        }

        /* ============================================================
           ЭКРАН АВТОРИЗАЦИИ — НОВЫЙ (DELTA + СИНИЙ НЕОН)
           ============================================================ */
        #authScreen {
            display: flex;
            flex-direction: column;
        ...
        .logo-d svg .d-inner {
            ...
            filter: drop-shadow(0 0 15px rgba(0, 136, 255, 0.05));
        }
        ...
        @keyframes logoPulse {
            0%, 100% { filter: drop-shadow(0 0 30px rgba(0, 102, 255, 0.1)); }
            50% { filter: drop-shadow(0 0 60px rgba(0, 102, 255, 0.2)); }
        }
        ...
        #authScreen .app-name {
            ...
            font-weight: 900;
            letter-spacing: 10px;
            background: linear-gradient(135deg, #0066ff, #0088ff, #0066ff);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            text-shadow: 0 0 60px rgba(0, 102, 255, 0.05);
            margin-top: -4px;
        ...
        #authScreen input:focus {
            ...
            box-shadow: 0 0 40px rgba(0, 102, 255, 0.02);
        ...
        #authScreen button:hover {
            ...
            box-shadow: 0 0 60px rgba(0, 102, 255, 0.02);
        ...
        .header {
            ...
            padding: 12px 18px;
            border-bottom: 1px solid rgba(0, 102, 255, 0.02);
            display: flex;
            align-items: center;
        ...
        /* ----- ЛОГОТИП "D" В ХЕДЕРЕ (ПРАВЫЙ ВЕРХНИЙ УГОЛ) ----- */
        .header-logo-d {
            width: 28px;
            height: 28px;
            filter: drop-shadow(0 0 20px rgba(0, 102, 255, 0.05));
            transition: 0.3s;
        }
        ...
        .header .right .btn {
            ...
            backdrop-filter: blur(8px);
            -webkit-backdrop-filter: blur(8px);
            border: 1px solid rgba(0, 102, 255, 0.02);
            border-radius: 12px;
            width: 34px;
            height: 34px;
        ...
        .header .right .btn.search-btn:hover {
            color: rgba(0, 102, 255, 0.15);
        }
        ...
        .story-row {
            ...
            gap: 14px;
            padding: 10px 18px;
            background: rgba(0, 102, 255, 0.005);
            border-bottom: 1px solid rgba(0, 102, 255, 0.01);
            overflow-x: auto;
            flex-shrink: 0;
        }
        .story-row::-webkit-scrollbar { height: 2px; }
        .story-row::-webkit-scrollbar-thumb { background: rgba(0, 102, 255, 0.02); border-radius: 4px; }
        ...
        .story-item .ring {
            ...
            border-radius: 50%;
            padding: 2px;
            background: linear-gradient(135deg, rgba(0, 102, 255, 0.02), rgba(0, 102, 255, 0.01));
            border: 1px solid rgba(0, 102, 255, 0.02);
            transition: 0.3s;
        }
        ...
        .story-item .ring.active {
            ...
            box-shadow: 0 0 30px rgba(0, 102, 255, 0.02);
        }

        .story-item .ring.viewed {
            border-color: rgba(0, 102, 255, 0.01);
            opacity: 0.3;
        }
        ...
        .action-buttons button {
            ...
            font-family: 'Orbitron', monospace;
            transition: 0.3s;
            border: 1px solid rgba(0, 102, 255, 0.01);
            background: rgba(0, 102, 255, 0.005);
            color: rgba(0, 102, 255, 0.08);
            letter-spacing: 1px;
        }
        ...
        .action-buttons button:hover {
            background: rgba(0, 102, 255, 0.01);
            border-color: rgba(0, 102, 255, 0.02);
            color: rgba(0, 102, 255, 0.15);
        }

        .action-buttons .channel-btn {
            color: #0066ff;
            border-color: rgba(0, 102, 255, 0.02);
        }

        .action-buttons .channel-btn:hover {
            background: rgba(0, 102, 255, 0.01);
        ...
        .action-buttons .group-btn {
            ...
            border-color: rgba(0, 136, 255, 0.01);
        }

        .action-buttons .group-btn:hover {
            background: rgba(0, 136, 255, 0.01);
            border-color: rgba(0, 136, 255, 0.02);
        }

        /* ----- СПИСОК ЧАТОВ (СИНИЙ НЕОН) ----- */
        .chat-list {
            flex: 1;
            overflow-y: auto;
            padding: 4px 0;
        ...
        .chat-list::-webkit-scrollbar-thumb { background: rgba(0, 102, 255, 0.02); border-radius: 4px; }
        ...
        .chat-item {
            ...
            cursor: pointer;
            transition: 0.2s;
            border-bottom: 1px solid rgba(0, 102, 255, 0.005);
        }
        ...
        /* ----- НИЖНЯЯ НАВИГАЦИЯ (СИНИЙ НЕОН) ----- */
        .bottom-nav {
            background: rgba(8, 12, 24, 0.6);
            backdrop-filter: blur(32px) saturate(1.8);
            -webkit-backdrop-filter: blur(32px) saturate(1.8);
            border-top: 1px solid rgba(0, 102, 255, 0.01);
            display: flex;
        ...
        .bottom-nav .nav-item.active .icon {
            text-shadow: 0 0 30px rgba(0, 102, 255, 0.02);
        }
        ...
        .msg.other {
            ...
            background: rgba(0, 102, 255, 0.005);
            border: 1px solid rgba(0, 102, 255, 0.005);
        ...
        .profile-actions .add-account-btn {
            ...
            border-color: rgba(0, 136, 255, 0.005);
        }
        ...
        .search-back:hover, .search-clear:hover {
            color: #0066ff;
        }
        ...
        .search-item .name { font-weight: 500; font-size: 13px; color: rgba(0, 102, 255, 0.04); }
        .search-item .sub { font-size: 11px; color: rgba(0, 102, 255, 0.02); }
        .search-item .badge {
            background: rgba(0, 102, 255, 0.005);
            padding: 2px 10px;
            border-radius: 12px;
        ...
        #callScreen .call-actions button:hover {
        ...
        #callScreen .call-actions .hangup-btn:hover {
        ...
        #callScreen .call-actions .answer-btn:hover {
...
<div id="app">
    ...
    <div id="authScreen">
        <div class="logo-d">
            <svg viewBox="0 0 100 100">
                <path class="d-glow" d="M 20 20 L 80 20 Q 90 20 90 30 L 90 70 Q 90 80 80 80 L 20 80 Q 10 80 10 70 L 10 30 Q 10 20 20 20 Z" />
                <path class="d-outline" d="M 20 20 L 80 20 Q 90 20 90 30 L 90 70 Q 90 80 80 80 L 20 80 Q 10 80 10 70 L 10 30 Q 10 20 20 20 Z" />
                <line class="d-inner" x1="30" y1="20" x2="30" y2="80" />
                <line class="d-inner" x1="35" y1="25" x2="85" y2="75" stroke-dasharray="10 5" />
                <circle class="d-outline" cx="85" cy="50" r="3" />
            </svg>
        </div>
        <div class="app-name">DELTA</div>
        <div class="app-slogan">UNDERGROUND MESSENGER</div>
        <div class="hack-text"><span>> root@delta:~$ ./connect --anonymize --encrypt</span></div>
    ...
    <div id="mainScreen">
        <div class="header">
            ...
            <div class="right">
                <button class="btn search-btn" onclick="openSearchMenu()">🔍</button>
                <button class="btn" onclick="uploadStory()">📸</button>
                <!-- ЛОГОТИП "D" В ПРАВОМ ВЕРХНЕМ УГЛУ -->
                <div class="header-logo-d" onclick="switchTab('profile')">
                    <svg viewBox="0 0 100 100">
                        <path class="d-outline" d="M 20 20 L 80 20 Q 90 20 90 30 L 90 70 Q 90 80 80 80 L 20 80 Q 10 80 10 70 L 10 30 Q 10 20 20 20 Z" />
                        <line class="d-inner" x1="30" y1="20" x2="30" y2="80" />
                        <circle class="d-outline" cx="85" cy="50" r="3" />
        ...
        <div id="tabContainer" style="flex:1;display:flex;flex-direction:column;overflow:hidden;">
            ...
            <div id="tab-chats" class="tab-content active" style="flex:1;display:flex;flex-direction:column;">
                ...
                <div class="action-buttons">
                    <button class="channel-btn" onclick="createChannel()">➕ КАНАЛ</button>
                    <button class="group-btn" onclick="showCreateGroup()">👥 ГРУППА</button>
                </div>
    ...
    <div id="chatView">
        ...
        <div class="messages-container" id="messagesContainer">
            <div id="messagesList" style="display:flex;flex-direction:column;flex:1;justify-content:center;align-items:center;color:rgba(0,102,255,0.02);font-size:14px;font-family:'Share Tech Mono',monospace;">
                <span style="font-size:48px;margin-bottom:8px;opacity:0.1;">🔮</span>
                > no messages
            </div>
        </div>
        <div class="msg-input-area">
            <button onclick="document.getElementById('photoInput').click()" style="background:none;border:none;color:rgba(0,102,255,0.02);font-size:18px;cursor:pointer;">📷</button>
...
<script>
    ...
    async function loadChats() {
        try {
            ...
            if (chats.length === 0) {
                list.innerHTML = `<div style="text-align:center;padding:40px 20px;color:rgba(0,102,255,0.02);font-size:13px;font-family:'Share Tech Mono',monospace;">
                    <p style="font-size:48px;margin-bottom:8px;opacity:0.1;">🔮</p>
                    <p>> no chats found</p>
    ...
    async function loadStories() {
        try {
            ...
            if (usernames.length === 0) {
                container.innerHTML = `<div style="color:rgba(0,102,255,0.02);font-size:12px;padding:4px 0;">Нет историй</div>`;
                return;
            }
    ...
    function showStoryViewer() {
        ...
        viewer.innerHTML = `
            ...
            <button class="nav-left" onclick="prevStory()">‹</button>
            <button class="nav-right" onclick="nextStory()">›</button>
            <div class="progress"><div class="fill" style="width:0%"></div></div>
            ${isVideo ? 
                `<video src="${story.media_url}" autoplay controls style="max-width:100%;max-height:70%;border-radius:12px;"></video>` :
                `<img src="${story.media_url}" alt="story" style="max-width:100%;max-height:70%;border-radius:12px;">`
            }
            ...
            <div style="color:rgba(0,102,255,0.02);font-size:14px;margin-top:8px;">${currentStoryIndex+1}/${stories.length}</div>
        `;
        ...
        if (isVideo) {
            ...
            video.onended = () => setTimeout(nextStory, 1000);
        }
    }
    ...
    async function reactToStory(reaction) {
        const stories = storiesData[currentStoryUser] || [];
        const story = stories[currentStoryIndex];
        if (!story) return;
        
        const res = await fetch('/story/react', {
            method: 'POST',
            headers: getVKHeaders(),
            body: JSON.stringify({story_id: story.id, reaction: reaction, username: currentUser})
        });
        const data = await res.json();
        if (data.status === 'reacted' || data.status === 'updated') {
            const viewer = document.getElementById('storyViewer');
            const toast = document.createElement('div');
            toast.style.cssText = 'position:absolute;top:60px;color:#0066ff;background:rgba(0,0,0,0.3);padding:8px 16px;border-radius:20px;font-size:14px;backdrop-filter:blur(8px);';
            toast.textContent = `Реакция ${reaction} добавлена!`;
    ...
    function addMessageToChat(msg) {
        ...
        if (msg.is_location) {
            content += `<div style="color:#0066ff;cursor:pointer;" onclick="window.open('https://www.openstreetmap.org/?mlat=${msg.latitude}&mlon=${msg.longitude}&zoom=15')">
    ...
    function showReactionPicker(messageId) {
        ...
        picker.style.cssText = `
            ...
            z-index: 1000; border: 1px solid rgba(0,102,255,0.01);
        `;
        reactions.forEach(r => {
            ...
            btn.style.cssText = `
                ...
                transition: 0.2s;
            `;
            btn.onmouseover = () => { btn.style.background = 'rgba(0,102,255,0.02)'; };
            btn.onmouseout = () => { btn.style.background = 'rgba(0,102,255,0.01)'; };
            btn.onclick = () => {
    ...
    async function globalSearch() {
        ...
        if (channels.length > 0) {
            html += `<div class="history-title">>> CHANNELS</div>`;
            channels.forEach(ch => {
                html += `
                    <div class="search-item" onclick="openChat('${ch.channel_id}', '${ch.title}'); closeSearchMenu();">
                        ...
                        <div class="info">
                            ...
                            <div class="sub">@${ch.username} • ${ch.subscribers} subscribers</div>
                        </div>
                        <div class="badge">${ch.admin === currentUser ? 'OWNER' : ''}</div>
                    </div>
                `;
            });
        }
        ...
        if (!html) {
            html = `<div style="padding:20px;text-align:center;color:rgba(0,102,255,0.02);">> no results found</div>`;
        }
    ...
    function renderSearchHistory() {
        ...
        if (searchHistory.length === 0) {
            container.innerHTML = `<div style="padding:16px;text-align:center;color:rgba(0,102,255,0.02);font-size:13px;">> no search history</div>`;
            return;
        }
        container.innerHTML = `
    ...
    async function createChannel() {
        ...
        if (!title) return;
        const username = prompt('🔑 Введите @username канала (уникальный, латиница):');
        if (!username) return;
    ...
    // ---- СОЗДАНИЕ ГРУППЫ (ПОШАГОВО) ----
    function showCreateGroup() {
        groupParticipants = [];
        groupTitle = prompt('👥 Название группы:');
        if (!groupTitle) return;
        addParticipantStep();
    }

    function addParticipantStep() {
        const currentList = groupParticipants.length > 0 ? groupParticipants.join(', ') : 'пока никого';
        const input = prompt(`👤 Введите имя участника (${groupParticipants.length + 1}):\n\nТекущие участники: ${currentList}\n\nДля завершения введите "готово" или оставьте пустым:`);
        ...
        if (trimmed === '' || trimmed.toLowerCase() === 'готово' || trimmed.toLowerCase() === 'done') {
        ...
        fetch(`/search_users?query=${trimmed}&username=${currentUser}`, { headers: getVKHeaders() })
            .then(res => res.json())
            .then(users => {
                if (users.length === 0) {
                    alert(`❌ Пользователь "${trimmed}" не найден`);
                    addParticipantStep();
                    return;
                }
                const found = users[0];
                if (groupParticipants.includes(found.username)) {
                    alert(`⚠️ ${found.username} уже добавлен`);
                    addParticipantStep();
                    return;
                }
                if (found.username === currentUser) {
                    alert('⚠️ Вы не можете добавить себя (вы будете добавлены автоматически)');
                    addParticipantStep();
                    return;
                }
                groupParticipants.push(found.username);
                alert(`✅ ${found.username} добавлен в группу`);
                addParticipantStep();
            })
            .catch(() => {
    ...
    async function createGroupFinal() {
        try {
            const res = await fetch('/create_group', {
                ...
                body: JSON.stringify({
                    title: groupTitle,
                    participants: groupParticipants.join(',')
                })
            });
            const data = await res.json();
            if (data.chat_id) {
                alert(`✅ Группа "${groupTitle}" создана! Участники: ${groupParticipants.join(', ')}`);
                groupParticipants = [];
                groupTitle = '';
                loadChats();
                switchTab('chats');
    ...
    async function renderProfile() {
        ...
        container.innerHTML = `
            ...
            <div class="profile-accounts">
                <div style="font-size:12px;color:rgba(0,102,255,0.02);margin-bottom:6px;text-align:left;">Мои аккаунты</div>
                ${accounts.map(acc => `
            ...
            <div class="profile-actions">
                ...
                <button onclick="logout()" style="color:#0066ff;text-align:center;">🚪 Выйти</button>
            </div>
        `;
    }
    ...
    async function switchAccountInstant(username) {
        ...
        document.getElementById('profileContent').innerHTML = `<div style="text-align:center;padding:40px;color:rgba(0,102,255,0.02);">🔄 Переключение...</div>`;
        ...
        try {
            ...
            document.querySelector('.header .left .title').textContent = '/' + currentUser.toUpperCase();
    ...
    async function viewProfile() {
        ...
        const roleDisplay = title === 'seconddurov' ? '👑 OWNER' : (data.role === 'admin' ? '⚡ ADMIN' : '👤 USER');
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <div style="text-align:center;">
                    ...
                    <div style="font-size:22px;font-weight:600;color:#c8d8e8;">${data.username}</div>
                    <div style="font-size:14px;color:rgba(0,102,255,0.02);margin:4px 0;">
                        ${roleDisplay} • ${data.emoji_status || '𖤐'}
                    </div>
                    <div style="font-size:14px;color:rgba(0,102,255,0.02);margin:4px 0;">
                        ${data.is_online ? '🟢 ONLINE' : '⚪ OFFLINE'}
                        ${data.last_seen ? ' • last: ' + formatTime(data.last_seen) : ''}
                    </div>
                    ${data.bio ? `<div style="font-size:13px;color:rgba(0,102,255,0.02);margin:8px 0;padding:8px;background:rgba(0,102,255,0.01);border-radius:8px;">${escapeHtml(data.bio)}</div>` : ''}
                    ${canMakeAdmin ? `
                        <button onclick="makeAdmin('${data.username}')" style="margin-top:8px;padding:8px 24px;background:rgba(0,102,255,0.02);color:#0066ff;border:1px solid rgba(0,102,255,0.01);border-radius:8px;cursor:pointer;font-size:14px;font-weight:500;">
                            👑 Сделать администратором
                        </button>
                    ` : ''}
                    ${isOwner && data.role === 'admin' && title !== 'seconddurov' ? `
                        <button onclick="removeAdmin('${data.username}')" style="margin-top:8px;padding:8px 24px;background:rgba(0,102,255,0.01);color:rgba(0,102,255,0.01);border:1px solid rgba(0,102,255,0.01);border-radius:8px;cursor:pointer;font-size:14px;font-weight:500;">
    ...
    async function loadCallHistory() {
        ...
        if (calls.length === 0) {
            container.innerHTML = `<div style="text-align:center;padding:40px 20px;color:rgba(0,102,255,0.02);font-size:14px;">
                <span style="font-size:48px;display:block;margin-bottom:8px;opacity:0.1;">📞</span>
                > нет истории звонков
            </div>`;
        } else {
            container.innerHTML = `
                <div style="font-size:12px;color:rgba(0,102,255,0.02);margin-bottom:8px;">>> ИСТОРИЯ ЗВОНКОВ</div>
                ${calls.map(c => `
                    <div style="display:flex;justify-content:space-between;padding:8px 12px;background:rgba(0,102,255,0.005);border-radius:8px;margin-bottom:4px;border:1px solid rgba(0,102,255,0.005);">
                        <div>
                            <span style="font-weight:500;color:rgba(0,102,255,0.02);">${c.caller === currentUser ? '📤' : '📥'} ${c.caller === currentUser ? c.callee : c.caller}</span>
                            <span style="font-size:10px;color:rgba(0,102,255,0.01);display:block;">${c.status === 'completed' ? '✅' : '❌'} ${c.duration ? c.duration + 'с' : ''}</span>
                        </div>
                        <div style="font-size:10px;color:rgba(0,102,255,0.01);">${formatTime(c.time)}</div>
                    </div>
                `).join('')}
            `;
        }
    ...
    function renderSettings() {
        ...
        container.innerHTML = `
            <div style="font-size:12px;color:rgba(0,102,255,0.02);margin-bottom:8px;">>> НАСТРОЙКИ</div>
            <div style="display:flex;flex-direction:column;gap:6px;">
                <div style="display:flex;justify-content:space-between;padding:10px 12px;background:rgba(0,102,255,0.005);border-radius:8px;border:1px solid rgba(0,102,255,0.005);">
                    <span style="color:rgba(0,102,255,0.02);">🌐 Прокси</span>
                    <span style="color:rgba(0,102,255,0.01);">Отключён</span>
                </div>
                <div style="display:flex;justify-content:space-between;padding:10px 12px;background:rgba(0,102,255,0.005);border-radius:8px;border:1px solid rgba(0,102,255,0.005);">
                    <span style="color:rgba(0,102,255,0.02);">🔒 Шифрование</span>
                    <span style="color:#0066ff;">AES-256-GCM</span>
                </div>
                <div style="display:flex;justify-content:space-between;padding:10px 12px;background:rgba(0,102,255,0.005);border-radius:8px;border:1px solid rgba(0,102,255,0.005);">
                    <span style="color:rgba(0,102,255,0.02);">📱 Устройств</span>
                    <span style="color:rgba(0,102,255,0.01);">${deviceId}</span>
                </div>
                <div style="display:flex;justify-content:space-between;padding:10px 12px;background:rgba(0,102,255,0.005);border-radius:8px;border:1px solid rgba(0,102,255,0.005);">
                    <span style="color:rgba(0,102,255,0.02);">📦 Версия</span>
                    <span style="color:rgba(0,102,255,0.01);">1.0 Fsociety</span>
                </div>
                ${isAdmin ? `
                    <div style="display:flex;justify-content:space-between;padding:10px 12px;background:rgba(0,102,255,0.005);border-radius:8px;border:1px solid rgba(0,102,255,0.005);cursor:pointer;" onclick="loadAdminStats()">
                        <span style="color:#0066ff;">👑 Админ-панель</span>
    ...
    async function switchTab(tab) {
        ...
        if (targetId) {
            ...
            if (el) {
                ...
                if (tab === 'profile') {
                    const userData = await fetch(`/profile/${currentUser}?viewer=${currentUser}`, { headers: getVKHeaders() });
                    const data = await userData.json();
                    isOwner = currentUser === 'seconddurov' || data.role === 'owner';
                    isAdmin = data.role === 'admin' || data.role === 'owner' || isOwner;
                    renderProfile();
                }
